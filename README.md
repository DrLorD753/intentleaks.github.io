...
<script type="c5c8bf1a045c1af9ed5f0613-text/javascript">!function(o,c){var n=c.documentElement,t=" w-mod-";n.className+=t+"js",("ontouchstart"in o||o.DocumentTouch&&c instanceof DocumentTouch)&&(n.className+=t+"touch")}(window,document);</script>
...
<div style="height: 100%; width: 100%; background-color: #2e2e2e; cursor:pointer;" onclick="if (!window.__cfRLUnblockHandlers) return false; forward()" data-cf-modified-c5c8bf1a045c1af9ed5f0613-=""></div>
<div id="client-sidebar-cover" style="width: 100%;height: 100px;position: absolute;bottom: 0;background: linear-gradient(0deg, rgba(46,46,46,1) 0%, rgba(46,46,46,0) 100%); display: flex; justify-content: center; align-items: flex-end; padding: 8px; pointer-events: none">
<h1 class="supported-devices" style="margin: 8px; margin-bottom: 0px"></h1>
</div>
</div>
<div data-animation="slide" data-duration="500" data-infinite="1" class="slider w-slider" id="client-slider">
<div class="w-slider-mask" id="client-mask">
<div class="slide w-slide" aria-label="1 of 10" role="group" aria-hidden="true">
<div class="slider-item" aria-hidden="true">
<div class="client-info-div" aria-hidden="true">
<div aria-hidden="true">
<h1 class="client-title" aria-hidden="true" style="display: inline-flex;">ZeroDay <div class="ph-item" style="margin-left: 12px;width: 100px;">
<div class="ph-col-10" style="padding-left: 0px; padding-right: 0px;">
<div class="ph-row">
...
<div class="column">
<a href="https://www.patreon.com/intentstore" target="_blank"><div class="item"><img src="images/intent-v3/patreon.png" srcset="images/intent-v3/patreon.png 500w, images/intent-v3/patreon.png 800w" sizes="(max-width: 479px) 100vw, (max-width: 767px) 66vw, (max-width: 991px) 28vw, 24vw" alt="" class="image">
...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11" type="c5c8bf1a045c1af9ed5f0613-text/javascript"></script>
<script src="js/anime.js" type="c5c8bf1a045c1af9ed5f0613-text/javascript"></script>
<script type="c5c8bf1a045c1af9ed5f0613-text/javascript">
  ...
  function loadProducts() {
    ...
    if (products.length > 1) {
      $("#navbar-expander").show()
      $("#game-switcher").show()
    }
  }

  function addGames(){
    const switcher = $("#game-switcher")[0]
    const panel = $("#client-panel")[0]
    const games = [{id: 1, name: "Name", slug: "slug", badge: "badge", products: [{
        id: 1,
        name: "Name",
        version: "2.0",
        ...
        price: "$9.99",
        connections: {
          intent_connect_code: "49kge",
          guilded_code: "idji4d",
          discord_code: "idgk4w",
          website_url: "https://intent.store/",
        }
      }]}/*, {id: 2, name: "Other", slug: "slug3", badge: "badge"}*/]

    for (let i = 0; i < games.length; i++) {
      const isLast = i === games.length - 1
      const game = games[i]

      const isSelected = defaultGame == game.id
      const additionalClasses = isSelected ? "unselected-game selected-game" : "unselected-game"

      if(game.badge === undefined || game.badge.length == 0){
        switcher.innerHTML += (`<h1 class="game-title ${additionalClasses}" id="game-${game.slug}-button" onclick="selectGame('${game.slug}');">${game.name}</h1>`)
      }else{
        switcher.innerHTML += (`<div class="badge-container" onclick='selectGame("${game.slug}");'>
        <h1 class="game-title ${additionalClasses}" id="game-${game.slug}-button" >${game.name}</h1>
        <h1 class="new-alert">${game.badge}</h1>
      </div>`)
      }

      panel.innerHTML += `<div class="sidebar" style="display: none" id="game-${game.slug}-sidebar" ></div>`
    ...
    <div class="slider-item-image" style="background-image: url(product/games/${game.slug}/${product.id}/${product.name.replace(" ", "%20")}-Carousel-1920.png);">
    ...
    <div class="slider-item">
      <div class="client-info-div">
        ...
        <div class="product-actions">
          ...
          ${client.connections.guilded_code !== undefined ? `<a href="https://guilded.gg/i/${client.connections.guilded_code}"><h1 style="min-height: 50px; min-width: 50px;" class="discord-join"></h1></a>` : ""}
  ...
  function loadUserInfo(userModel){
